    ...
    <div class="m-20">
        <div class="block p-6 rounded-lg shadow-lg bg-white px-5">
            <div class="relative w-full px-4 max-w-full flex-grow flex-1 mb-5">
                <h3 class="font-bold text-lg text-gray-900">Add New Vacancy</h3>
            </div>
            ...
            <form action="{{ route('user-add-portifolio') }}" method="POST">
                @csrf
                <div class="grid xl:grid-cols-2 xl:gap-6 mb-5">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="firstname" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8" placeholder="Firstname" required>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="lastname" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8" placeholder="Lastname" required>
                    </div>
                </div>
                <div class="grid xl:grid-cols-2 xl:gap-6 mb-5">
                    <div class="relative z-0 w-full mb-6 group">
                        <select name="gender" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8">
                ...
                <div class="grid xl:grid-cols-2 xl:gap-6 mb-5">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="address" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8" placeholder="Address" required>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="date" name="dob" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8" required>
                    </div>
                </div>
              <button type="submit" class=" w-full px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md
                ...
                active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Save</button>
            </form>
        </div>
    </div>
</x-app-layout>
