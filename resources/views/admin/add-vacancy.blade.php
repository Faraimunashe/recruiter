<x-app-layout>
    <div class="m-20">
        <div class="block p-6 rounded-lg shadow-lg bg-white px-5">
            ...
            <form action="{{ route('admin-v-add') }}" method="POST">
                @csrf
                <div class="form-group mb-6">
                    <input type="text" name="position" required class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput7" placeholder="Vacancy Position">
                </div>
                <div class="form-group mb-6">
